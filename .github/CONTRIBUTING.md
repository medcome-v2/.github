...
1. **merge commit**: یک commit جدید ایجاد شده و دو شاخه را با هم ادغام می کند.
2. **squash**: همه commit ها در قالب یک commit به شاخه اصلی اضافه می شوند.
3. **rebase**: در این روش commit ها از شاخه اول به شاخه دوم منتقل می شوند.
